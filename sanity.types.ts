...
export type ImageCaptionList = {
  _type: "image-caption-list";
  title?: string;
  imageCaptionList?: Array<{
    image?: {
      asset?: {
        _ref: string;
        _type: "reference";
